...
import ch.skyguide.message.structure.dataitem.AbstractUniversalReservedDataItem;

//------------------------------------------------------------------------------

/*******************************************************************************
* Represents for universal variabled length data item which does require packing
* and unpacking. 
* 
* @author Guillaume Fouillet
*/
public final class LoggingUniversalReservedDataItem 
extends AbstractUniversalReservedDataItem
{
    //--------------------------------------------------------------------------
    ...
    */
    public LoggingUniversalReservedDataItem(short dataCategory, 
                                     int dataItemIdentifier, 
                                     String description, 
                                     String units, 
                                     int lengthFieldSize) 
   {
       super(dataCategory, dataItemIdentifier, description, units, lengthFieldSize);
   }
   //--------------------------------------------------------------------------
