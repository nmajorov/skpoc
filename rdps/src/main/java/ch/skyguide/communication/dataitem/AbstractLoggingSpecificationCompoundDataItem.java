...
import ch.skyguide.message.structure.dataitem.AbstractSpecificationCompoundDataItem;
...
/*******************************************************************************
* Container for the Specification Compound Data Item.
*
* @author Guillaume Fouillet
*/
public abstract class AbstractLoggingSpecificationCompoundDataItem 
extends AbstractSpecificationCompoundDataItem 
{
    ...
    *
    */
    protected AbstractLoggingSpecificationCompoundDataItem(short dataCategory,
                                     ...
                                     SpecificationSubTypeDescriptor subtypeDescriptor)
    {
        super(dataCategory, 
              dataItemIdentifier, 
              description, 
              units, primarySubFieldLength,
              secondaryDataItems, subtypeDescriptor);
    }
